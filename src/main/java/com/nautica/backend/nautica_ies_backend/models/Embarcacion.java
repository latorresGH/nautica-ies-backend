...
public class Embarcacion {
    ...
    public String getMarcaCasco() { return marcaCasco; }
    public void setMarcaCasco(String marcaCasco) { this.marcaCasco = marcaCasco; }

    public String getModeloCasco() { return modeloCasco; }
    public void setModeloCasco(String modeloCasco) { this.modeloCasco = modeloCasco; }

    public String getDescripcion() { return descripcion; }
    public void setDescripcion(String descripcion) { this.descripcion = descripcion; }

    public String getMarcaMotor() { return marcaMotor; }
    public void setMarcaMotor(String marcaMotor) { this.marcaMotor = marcaMotor; }

    public String getModeloMotor() { return modeloMotor; }
    public void setModeloMotor(String modeloMotor) { this.modeloMotor = modeloMotor; }

    public String getNumMotor() { return numMotor; }
    public void setNumMotor(String numMotor) { this.numMotor = numMotor; }

    public Integer getPotenciaMotor() { return potenciaMotor; }
    public void setPotenciaMotor(Integer potenciaMotor) { this.potenciaMotor = potenciaMotor; }
    ...
    public List<UsuarioEmbarcacion> getUsuarios() { return usuarios; }
    public void setUsuarios(List<UsuarioEmbarcacion> usuarios) { this.usuarios = usuarios; }
}
